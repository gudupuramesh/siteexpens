/**
 * Bottom-sheet modal listing organization members (same UX as MemberPickerModal).
 */
...
export function OrgMemberPickerModal({ visible, orgId, onPick, onClose, allowUnassign }: Props) {
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              <Text variant="meta" color="textMuted">
                {loading ? 'Loading…' : search ? 'No matches' : 'No members in this org'}
              </Text>
            </View>
          }
        />
